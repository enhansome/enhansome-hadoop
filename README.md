...
A curated list of amazingly awesome Hadoop and Hadoop ecosystem resources. Inspired by [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,689 | 🐛 90 | 📅 2026-07-13, [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 320,114 | 🐛 22 | 🌐 Python | 📅 2026-09-01 and [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,342 | 🐛 272 | 📅 2024-03-26
...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 392 | 🌐 Java | 📅 2026-09-12 - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) ⭐ 46,836 | 🐛 2,152 | 🌐 Python | 📅 2026-09-12 - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,665 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 and [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,230 | 🐛 106 | 📅 2026-09-02 list.

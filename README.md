...
* [Elasticsearch Hadoop](https://github.com/elastic/elasticsearch-hadoop) ⭐ 1,972 | 🐛 134 | 🌐 Java | 📅 2026-08-11 - Elasticsearch real-time search and analytics natively integrated with Hadoop. Supports Map/Reduce, Cascading, Apache Hive and Apache Pig.
...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) ⭐ 2,461 | 🐛 393 | 🌐 Java | 📅 2026-08-15 - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) ⭐ 46,509 | 🐛 1,882 | 🌐 Python | 📅 2026-08-17 - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,610 | 🐛 60 | 🌐 Ruby | 📅 2024-06-02 and [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,615 | 🐛 100 | 📅 2026-06-30 list.

...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) ⭐ 2,461 | 🐛 398 | 🌐 Java | 📅 2026-08-24 - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) ⭐ 46,590 | 🐛 1,921 | 🌐 Python | 📅 2026-08-23 - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,619 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02 and [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,329 | 🐛 106 | 📅 2026-08-21 list.

...
A curated list of amazingly awesome Hadoop and Hadoop ecosystem resources. Inspired by [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,706 | 🐛 92 | 📅 2026-07-13, [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 322,626 | 🐛 21 | 🌐 Python | 📅 2026-09-23 and [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,338 | 🐛 274 | 📅 2024-03-26
...
* [Elasticsearch Hadoop](https://github.com/elastic/elasticsearch-hadoop) ⭐ 1,971 | 🐛 139 | 🌐 Java | 📅 2026-09-23 - Elasticsearch real-time search and analytics natively integrated with Hadoop. Supports Map/Reduce, Cascading, Apache Hive and Apache Pig.
...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) ⭐ 2,464 | 🐛 391 | 🌐 Java | 📅 2026-09-24 - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) ⭐ 46,958 | 🐛 2,076 | 🌐 Python | 📅 2026-09-24 - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
* [Luigi](http://luigi.readthedocs.org/en/latest/) - Python package that helps you build complex pipelines of batch jobs

## Data Ingestion and Integration

* [Gobblin from LinkedIn](https://github.com/linkedin/gobblin) ⭐ 2,271 | 🐛 143 | 🌐 Java | 📅 2026-07-31 - Universal data ingestion framework for Hadoop
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,684 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02 and [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,571 | 🐛 106 | 📅 2026-09-02 list.

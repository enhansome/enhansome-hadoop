...
A curated list of amazingly awesome Hadoop and Hadoop ecosystem resources. Inspired by [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,705 | 🐛 92 | 📅 2026-07-13, [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 322,399 | 🐛 21 | 🌐 Python | 📅 2026-09-22 and [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,337 | 🐛 274 | 📅 2024-03-26
...
* [Elasticsearch Hadoop](https://github.com/elastic/elasticsearch-hadoop) ⭐ 1,971 | 🐛 139 | 🌐 Java | 📅 2026-09-22 - Elasticsearch real-time search and analytics natively integrated with Hadoop. Supports Map/Reduce, Cascading, Apache Hive and Apache Pig.
...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 393 | 🌐 Java | 📅 2026-09-23 - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) ⭐ 46,954 | 🐛 2,105 | 🌐 Python | 📅 2026-09-23 - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,682 | 🐛 66 | 🌐 Ruby | 📅 2024-06-02 and [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,117 | 🐛 106 | 📅 2026-09-02 list.

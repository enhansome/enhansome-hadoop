...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) ⭐ 2,465 | 🐛 392 | 🌐 Java | 📅 2026-09-21 - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) ⭐ 46,925 | 🐛 2,122 | 🌐 Python | 📅 2026-09-21 - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,682 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 and [awesome](https://github.com/sindresorhus/awesome) ⭐ 508,342 | 🐛 106 | 📅 2026-09-02 list.

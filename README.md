...
A curated list of amazingly awesome Hadoop and Hadoop ecosystem resources. Inspired by [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,648 | 🐛 81 | 📅 2026-07-13, [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 313,644 | 🐛 25 | 🌐 Python | 📅 2026-08-05 and [Awesome Sysadmin](https://github.com/kahun/awesome-sysadmin) ⭐ 24,347 | 🐛 270 | 📅 2024-03-26
...
* [Elasticsearch Hadoop](https://github.com/elastic/elasticsearch-hadoop) ⭐ 1,974 | 🐛 134 | 🌐 Java | 📅 2026-08-11 - Elasticsearch real-time search and analytics natively integrated with Hadoop. Supports Map/Reduce, Cascading, Apache Hive and Apache Pig.
* [Genie](https://github.com/Netflix/genie) ⭐ 1,766 | 🐛 19 | 🌐 Java | 📅 2026-07-13 - Genie provides REST-ful APIs to run Hadoop, Hive and Pig jobs, and to manage multiple Hadoop resources and perform job submissions across them.
...
* [White Elephant](https://github.com/linkedin/white-elephant) ⚠️ Archived - Hadoop log aggregator and dashboard
...
* [mpich2-yarn](https://github.com/alibaba/mpich2-yarn) ⭐ 115 | 🐛 19 | 🌐 Java | 📅 2017-10-08 - Running MPICH2 on Yarn

## NoSQL

*Next Generation Databases mostly addressing some of the points: being non-relational, distributed, open-source and horizontally scalable.*

* [happybase](https://github.com/wbolster/happybase) ⭐ 608 | 🐛 34 | 🌐 Python | 📅 2026-03-16 - A developer-friendly Python library to interact with Apache HBase.
...
* [Confluent Schema registry for Kafka](https://github.com/confluentinc/schema-registry) ⭐ 2,459 | 🐛 394 | 🌐 Java | 📅 2026-08-13 - Schema Registry provides a serving layer for your metadata. It provides a RESTful interface for storing and retrieving Avro schemas.
...
* [Apache AirFlow](https://github.com/apache/incubator-airflow) ⭐ 46,457 | 🐛 1,889 | 🌐 Python | 📅 2026-08-13 - Airflow is a workflow automation and scheduling system that can be used to author and manage data pipelines
* [Luigi](http://luigi.readthedocs.org/en/latest/) - Python package that helps you build complex pipelines of batch jobs

## Data Ingestion and Integration

* [Gobblin from LinkedIn](https://github.com/linkedin/gobblin) ⭐ 2,269 | 🐛 142 | 🌐 Java | 📅 2026-07-31 - Universal data ingestion framework for Hadoop
...
* [Lipstick](https://github.com/Netflix/Lipstick) ⭐ 466 | 🐛 13 | 🌐 JavaScript | 📅 2023-03-24 - Pig workflow visualization tool. [Introducing Lipstick on A(pache) Pig](http://techblog.netflix.com/2013/06/introducing-lipstick-on-apache-pig.html)
...
* [vahara](https://github.com/thedatachef/varaha) ⭐ 53 | 🐛 2 | 🌐 Java | 📅 2013-12-17 - Machine learning and natural language processing with Apache Pig
...
* [hdfs - A native go client for HDFS](https://github.com/colinmarc/hdfs) ⭐ 1,404 | 🐛 54 | 🌐 Go | 📅 2025-01-22
* [Elephant Bird](https://github.com/twitter/elephant-bird) ⭐ 1,134 | 🐛 87 | 🌐 Java | 📅 2023-04-10 - Twitter's collection of LZO and Protocol Buffer-related Hadoop, Pig, Hive, and HBase code.
...
* [Banana](https://github.com/LucidWorks/banana) ⭐ 673 | 🐛 109 | 🌐 JavaScript | 📅 2026-05-28 - Kibana port for Apache Solr
...
* [YCSB](https://github.com/brianfrankcooper/YCSB) ⭐ 5,232 | 🐛 383 | 🌐 Java | 📅 2026-08-12 - The Yahoo! Cloud Serving Benchmark (YCSB) is an open-source specification and program suite for evaluating retrieval and maintenance capabilities of computer programs. It is often used to compare relative performance of NoSQL database management systems.
* [HiBench](https://github.com/intel-hadoop/HiBench) ⚠️ Archived
* [Big Data Benchmark](https://amplab.cs.berkeley.edu/benchmark/)

## Machine learning and Big Data analytics

* [Oryx 2](https://github.com/OryxProject/oryx) ⚠️ Archived - Lambda architecture on Spark, Kafka for real-time large scale machine learning
* [RHadoop](https://github.com/RevolutionAnalytics/RHadoop/wiki) ⭐ 759 | 🐛 61 | 📅 2015-11-24 including RHDFS, RHBase, RMR2, plyrmr
...
* Hive Plugins
* UDF
  * <https://github.com/twitter/elephant-bird> ⭐ 1,134 | 🐛 87 | 🌐 Java | 📅 2023-04-10 - Twitter
  * <https://github.com/livingsocial/HiveSwarm> ⭐ 102 | 🐛 3 | 🌐 Java | 📅 2016-05-02
  * <https://github.com/ThinkBigAnalytics/Hive-Extensions-from-Think-Big-Analytics> ⭐ 16 | 🐛 2 | 🌐 Java | 📅 2014-08-19
  * <https://github.com/edwardcapriolo/hive_cassandra_udfs> ⭐ 11 | 🐛 0 | 🌐 Java | 📅 2012-03-30
  * <https://github.com/lovelysystems/ls-hive> ⚠️ Archived
  * <https://github.com/klout/brickhouse>
* Storage Handler
  * <https://github.com/yc-huang/Hive-mongo> ⭐ 33 | 🐛 12 | 🌐 Java | 📅 2023-04-14
  * <https://github.com/chimpler/hive-solr> ⭐ 16 | 🐛 1 | 🌐 Java | 📅 2014-03-17
  * <https://github.com/dvasilen/Hive-Cassandra> ⭐ 15 | 🐛 2 | 🌐 Java | 📅 2016-04-20
...
* Libraries and tools
  ...
  * <https://github.com/forward/node-hive> ⭐ 60 | 🐛 7 | 🌐 JavaScript | 📅 2018-05-18
  * <https://github.com/recruitcojp/WebHive> ⭐ 19 | 🐛 9 | 🌐 JavaScript | 📅 2014-01-28
  * <https://github.com/recruitcojp/OdbcHive> ⭐ 8 | 🐛 1 | 🌐 C++ | 📅 2011-07-22
  * <https://github.com/synctree/activerecord-hive-adapter> ⭐ 5 | 🐛 0 | 📅 2011-06-09
  * <https://github.com/hrp/sequel-hive-adapter> ⭐ 5 | 🐛 1 | 🌐 Ruby | 📅 2024-09-04
  * <https://github.com/dmorel/Thrift-API-HiveClient2> ⭐ 0 | 🐛 0 | 🌐 Perl | 📅 2023-08-06 (Perl - HiveServer2)
* Flume Plugins
  * [Flume MongoDB Sink](https://github.com/leonlee/flume-ng-mongodb-sink) ⭐ 72 | 🐛 0 | 🌐 Java | 📅 2023-03-03
  * [Flume RabbitMQ source and sink](https://github.com/jcustenborder/flume-ng-rabbitmq) ⭐ 59 | 🐛 6 | 🌐 Java | 📅 2023-12-16
  * [.Net FlumeNG Clients](https://github.com/marksl/DotNetFlumeNG.Clients) ⭐ 17 | 🐛 1 | 🌐 C# | 📅 2014-07-18
  * [Flume UDP Source](https://github.com/whitepages/flume-udp-source) ⚠️ Archived
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,603 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02 and [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,052 | 🐛 100 | 📅 2026-06-30 list.
